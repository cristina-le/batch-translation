...
class JapaneseToEnglishTranslator:
    ...
    """
    def __init__(self, api_key: Optional[str] = None, temperature: float = 0.2, model = "openai/gpt-4o-mini", context_window: int = 3):
        """
        Initialize the translator with API key, temperature, model, and context window.
